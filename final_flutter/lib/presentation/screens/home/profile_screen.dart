...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void initState() {
    ...
    settingState = context.read<SettingsBloc>().state;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:
          settingState!.isDarkMode ? AppColors.surfaceDark : AppColors.surface,
      appBar: AppBar(
        title: Text(
          'Profile',
          style: TextStyle(
  ...
  void _showPasswordRecovery() {
    if (user!.twoStepVerification! == true) {
      ...
      context.read<AuthBloc>().add(PasswordRecovery(""));
    }
  }
          ...
          (context) => AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                child: Text('Send', style: TextStyle(color: AppColors.surface)),
              ),
            ],
          ),
    );
          ...
          (context) => AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                child: Text('Save', style: TextStyle(color: AppColors.surface)),
              ),
            ],
          ),
    );
        ...
        child: Column(
          children: [
            ...
            Text(
              ...
              style: TextStyle(fontSize: 16, color: AppColors.surfaceVariant),
            ),
            const SizedBox(height: 20),
            ElevatedButton.icon(
        ...
        children: [
          Padding(
            ...
            child: Text(
              'Security Settings',
              style: TextStyle(
                fontSize: settingState!.fontSize + 4,
                fontWeight: FontWeight.bold,
                color:
                    settingState!.isDarkMode
                        ? AppColors.surfaceVariant
          ...
          _buildSettingsTile(
            ...
            subtitle: 'Enter your otp if you have enabled 2FA',
            color: AppColors.secondary,
