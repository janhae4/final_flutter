...
class SentScreen extends StatefulWidget {
  ...
  const SentScreen({super.key, required this.repository, this.fontFamily = 'Roboto', this.fontSize = 16});
...
class _SentScreenState extends State<SentScreen> {
  ...
  void _onScroll() {
    if (_scrollController.position.pixels >= _scrollController.position.maxScrollExtent - 100) {
      final total = widget.repository.sent.length;
  ...
  Widget build(BuildContext context) {
    final emails = widget.repository.sent.take(_currentMax).toList()
